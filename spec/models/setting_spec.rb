...
RSpec.describe Submission, type: :model do
  ...
  it "validates that preparation comes before registration" do
    ...
    expect(FactoryBot.build(:setting, params)).not_to be_valid
  end
  ...
  it "correctly calculates end_of_registration_period on read" do
    ...
    setting = FactoryBot.build(:setting, { beginning_of_closed_period: beginning_of_closed_period })
  ...
  it "correctly calculates end_of_registration_period on write" do
    ...
    setting = FactoryBot.build(:setting, { end_of_registration_period: end_of_registration_period })
